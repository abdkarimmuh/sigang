  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        ...
        style="opacity: .8">
        <span class="brand-text font-weight-light">SIGANG-PNJ</span>
      </a>
      <!-- Sidebar -->
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="../kaprodi/index.php" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="../kaprodi/datamahasiswa.php" class="nav-link">
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p >Data Mahasiswa</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/datadosen.php" class="nav-link">
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p >Data Dosen</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/dosenwali.php" class="nav-link">
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p >Data Dosen Wali</p>
                        </a>
                    </li>
                ...
                <ul class="nav nav-treeview">
                <li class="nav-item">
                        <a href="../kaprodi/kp_datapkl.php" class="nav-link">
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p >Data PKL</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="../kaprodi/kp_pendaftarsidangpkl.php" class="nav-link">
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p >Penjadwalan Sidang PKL</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_sidangpkl.php" class="nav-link">
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p >Sidang PKL</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_filepkl.php" class="nav-link">
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p >File PKL</p>
                        </a>
                    </li>
            ...
            <li class="nav-item has-treeview">
                    ...
                    <li class="nav-item">
                        ...
                        <i class="nav-cion fas fa-eye" style="text-indent: 15px;"></i>
                        <p style="text-indent: 15px;">Data Judul</p>
                        </a>
                    </li>
                    <!-- <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                <li class="nav-item">
                        <a href="../kaprodi/kp_dataproposal.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Data Proposal</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="../kaprodi/kp_pendaftarsidangproposal.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Penjadwalan Sidang Proposal</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_sidangproposal.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Sidang Proposal</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_fileproposal.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>File Proposal</p>
                        </a>
                    </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                <li class="nav-item">
                        <a href="../kaprodi/kp_verifikasidosbing.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Pemilihan Dosbing 1&2</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_dataskripsi.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Skripsi</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="../kaprodi/kp_pendaftarsidangdraft.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Penjadwalan Sidang Draft</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_sidangdraft.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Sidang Draft</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="../kaprodi/kp_pendaftarsidangpend.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Penjadwalan Sidang Pendadaran</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_sidangpend.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Sidang Pendadaran</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../kaprodi/kp_fileskripsi.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>File Skripsi</p>
                        </a>
                    </li>
          ...
          <li class="nav-item has-treeview">
                ...
                <!-- <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="../kaprodi/pengajuanjudul.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                        <p>Pengajuan Judul</p>
                        </a>
                    </li>
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                        <a href="../kaprodi/kp_validasisidpkl.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                        <a href="../kaprodi/kp_validasisidprop.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                        <a href="../kaprodi/kp_validasisiddraft.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
                  ...
                  <li class="nav-item">
                        <a href="../kaprodi/kp_validasisidpend.php" class="nav-link">
                        <i class="nav-cion fas fa-eye"></i>
