    ...
    if (isset($_POST["inputmhs"])) {
        ...
        $nama = $_POST["validasi"];
        $prodi = $_POST["pesan"];
        $insertakun = mysqli_query($conn, "UPDATE pkl_syarat SET status='$nama',
    ...
    <?php
        ...
        if (isset($_GET["id"])) {
            ...
            $sql = mysqli_query($conn, "DELETE FROM mahasiswa WHERE nim='$id'");
            if ($sql) {
                "<script>
    ...
    <head>
        ...
        <title>SIM-PS | Validasi Persyaratan PKL | Tata Usaha </title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                ...
                "SELECT * FROM pkl_syarat INNER JOIN mahasiswa ON pkl_syarat.nim=mahasiswa.nim
             ...
             ?>
                                    <tr>
                                        ...
                                        <td align="center"><a
                                                href="../../assets/persyaratan_pkl/<?= $data["file"] ?>"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">FORM VALIDASI PERSYARATAN PKL</h4>
