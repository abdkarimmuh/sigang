...
if (isset($_POST["login"])) {
  ...
  if (mysqli_num_rows($sql_mhs) > 0) {
    ...
    echo "<script>
    alert('Mohon Maaf,Akun anda tidak ditemukan. Silahkan coba lagi !')
...
<head>
  ...
  <title>SIGANG-PNJ | Akses Login</title>
...
<div class="jumbotron">
  <center>
    ...
    <h3 class="display-5"><b>Sistem Informasi Manajemen Magang dan Skripsi</b></h3>
    <p class="lead">Sistem Informasi Manajemen Magang dan Skripsi <b>(SIGANG-PNJ)</b> merupakan sistem
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">PORTAL AKSES SIGANG-PNJ</h5>
      ...
      <div class="modal-body">
        <form method="post">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="PIN" name="password" id="password1" required>
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <input type="checkbox" class="form-check-label"> Tampilkan Password
